...
data_in = (data_nor * data_std) + data_mean
t2_array = T2_array(data_in, data_mean, data_std, p_k, v_I)
plot_array(t2_array, title="Hotelling T² over time", x_label="Time", y_label="T²",
            figsize=(12, 4), save_path=None, show=True)
